...
wpas wpa[] = {
    ...
    {"SUA_REDE_AQUI", "SENHA_DA_SUA_REDE_AQUI"}
};
...
#define _DESCRIPTION "MIJ LoRa Gateway - JVTECH"		    // Name of the gateway
#define _EMAIL "phfbertoleti@gmail.com"		               // Owner
#define _PLATFORM "ESP32"                     			   // Platform
#define _LAT -22.894358                                // Latitude
#define _LON -47.0487551                               // Longitude
